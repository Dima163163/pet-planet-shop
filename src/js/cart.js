...
export const cartButton = document.querySelector('.store__cart-button');
...
export const cartCount = cartButton.querySelector('.store__cart-cnt');
export const cartTotalPriceElement =
	document.querySelector('.modal__cart-price');
